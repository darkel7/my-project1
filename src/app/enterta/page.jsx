...
export default function page() {
  return (
    <div className=' w-[70%] ml-[180px] h-4/5 mt-[40px] sm:grid-cols-1'>
        ...
        <p className='h-7 w-15 bg-red-300 font-bold'>Entertainmnet</p>
        <p>April 11, 2024</p>
        </div>
        <div>
        ...
        <div>
            <Image src='/entertainment2.jpg' alt='art' width='800' height='400' className='w-[100%] ml-[7px] mt-24 h-[600px]'/>
        </div>
        <div>
